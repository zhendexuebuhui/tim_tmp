...
apply_profile(){
  case "$1" in
    safe)
      MAX_MODEL_LEN="${MAX_MODEL_LEN:-${MAX_MODEL_LEN_OVERRIDE:-4096}}"
      MAX_RUNNING_REQUESTS="${MAX_RUNNING_REQUESTS:-${MAX_RUNNING_REQUESTS_OVERRIDE:-1}}"
      MEM_FRACTION_STATIC="${MEM_FRACTION_STATIC:-${MEM_FRACTION_STATIC_OVERRIDE:-0.75}}"
      CHUNKED_PREFILL_SIZE="${CHUNKED_PREFILL_SIZE:-${CHUNKED_PREFILL_SIZE_OVERRIDE:-4096}}" ;;
    optimized)
      MAX_MODEL_LEN="${MAX_MODEL_LEN:-${MAX_MODEL_LEN_OVERRIDE:-16384}}"
      MAX_RUNNING_REQUESTS="${MAX_RUNNING_REQUESTS:-${MAX_RUNNING_REQUESTS_OVERRIDE:-4}}"
      MEM_FRACTION_STATIC="${MEM_FRACTION_STATIC:-${MEM_FRACTION_STATIC_OVERRIDE:-0.82}}"
      CHUNKED_PREFILL_SIZE="${CHUNKED_PREFILL_SIZE:-${CHUNKED_PREFILL_SIZE_OVERRIDE:-4096}}" ;;
